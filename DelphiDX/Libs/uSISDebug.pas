...

{
    ...
    obs:
        ...
        SIS.Lib - indica funÁ„o globais ou genericas de tratamentos de dados
...
begin
    ...
    // checa o endereÁo passado em sDIr e verifica se o caminho todo È v·lido
...
begin
    ...
    MessageDlg('AtenÁ„o: ' + Mensagem + IfThen(Length(MensagemNova) > 0, ' ' + MensagemNova, ''), mtInformation, [mbOK],0);
...
//                FResultado.Mensagem := 'Informe a tabela para execuÁ„o';
//                FExecute            := False;
//                Exit;
//            end;
//
...
//            Result.Erro := True;
//            Result.Mensagem := 'Informe a instruÁ„o sql do where para o update!';
//            Exit;
//        end;
//
//        Result.Erro := False;
    ...
    try
        ...
        try
            ...
            Application.ProcessMessages;
                ...
                Result.Erro     := True;
                Result.Mensagem := 'Erro execuÁ„o comando: '+ E.ClassName + ' - ' + E.Message;
            end;
        end;
...
//            HttpResponse.Response := 'Falha na comunicaÁ„o com o servidor.';
//
//
//     finally
//           Result   := HttpResponse;
